...
def create_dataloaders(
    ...
    return (
        build_dataloader([all_data[i] for i in train_idx], batch_size=batch_size, shuffle=True, device=device),
        build_dataloader([all_data[i] for i in val_idx], batch_size=batch_size, shuffle=False, device=device),
        build_dataloader([all_data[i] for i in test_idx], batch_size=batch_size, shuffle=False, device=device),
    )
