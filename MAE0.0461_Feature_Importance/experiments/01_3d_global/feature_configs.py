...
THREE_D_GLOBAL_FEATURE_NAMES: List[str] = [
    "radius_of_gyration",
    "asphericity",
    "eccentricity",
...
NUM_3D_GLOBAL_FEATURES: int = len(THREE_D_GLOBAL_FEATURE_NAMES)
...
GLOBAL_FEATURE_DIM: int = len(Descriptors.descList) + NUM_3D_GLOBAL_FEATURES
