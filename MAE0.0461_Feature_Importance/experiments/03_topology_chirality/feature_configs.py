...
CHIRAL_FEATURE_NAMES: List[str] = ["cip_R", "cip_S", "chiral_possible"]
NUM_CHIRAL_FEATURES: int = len(CHIRAL_FEATURE_NAMES)

RING_SIZE_FEATURE_NAMES: List[str] = ["ring3", "ring4", "ring5", "ring6", "ring7plus"]
NUM_RING_SIZE_FEATURES: int = len(RING_SIZE_FEATURE_NAMES)

TOPOLOGY_GLOBAL_FEATURE_NAMES: List[str] = [
    "bridgehead_count",
    "spiro_count",
    "ring3_count",
    "ring4_count",
...
NUM_TOPOLOGY_GLOBAL_FEATURES: int = len(TOPOLOGY_GLOBAL_FEATURE_NAMES)
...
TOTAL_FEATURE_DIMENSION: int = (
    ATOM_TYPE_DIM + HYB_DIM + 1 + TOTAL_H_DIM + FORMAL_CHARGE_DIM + 1 + DEGREE_DIM + 1 +
    NUM_NEIGHBOR_FEATURES + NUM_FUNC_GROUPS + NUM_CHIRAL_FEATURES + NUM_RING_SIZE_FEATURES
)
...
GLOBAL_FEATURE_DIM: int = len(Descriptors.descList) + NUM_TOPOLOGY_GLOBAL_FEATURES
